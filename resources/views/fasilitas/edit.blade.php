                  ...
                  <div class="card-body">
                      ...
                      <form action="{{ route('fasilitas.update', $fasilita->id) }}" method="POST">
                          ...
                          <div class="form-group row mt-3">
                              ...
                              <div class="col-md-6">
                                  <input type="text" id="nama_fasilitas" class="form-control" name="nama_fasilitas" value="{{ $fasilita->nama_fasilitas }}" required autofocus>
                          ...
                          <div class="form-group row mt-3">
                              ...
                              <div class="col-md-6">
                                  <input type="text" id="alamat" class="form-control" name="alamat" value="{{ $fasilita->alamat }}" required autofocus>
                          ...
                          <div class="form-group row mt-3">
                              ...
                              <div class="col-md-6">
                                  <input type="text" id="Pj_fasilitas" class="form-control" name="Pj_fasilitas" value="{{ $fasilita->Pj_fasilitas }}" required autofocus>
                            ...
                            <div class="col-md-6">
                                <select class="form-select" id="kondisi" name="kondisi" aria-label="kondisi">
                                    ...
                                    @foreach($kondisis as $val)
                                        <option value="{{$val->guid}}" {{ ( $val->guid == $fasilita->kondisi_id ) ? 'selected' : ''}}>{{$val->name}}</option>
                                    @endforeach
                                </select>
